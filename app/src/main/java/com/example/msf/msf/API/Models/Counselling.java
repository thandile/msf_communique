...
public class Counselling {
    ...
    public Counselling(int patient, int counselling_session_type, String notes,
    ...
    public Counselling(int id, int patient, String  counselling_session_type, String notes, String date){
    ...
    public Counselling(int id, String patient_name, String session_type, String notes){
